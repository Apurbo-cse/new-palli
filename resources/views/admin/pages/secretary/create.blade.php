        ...
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li><a href="{{route('admin.member.index')}}">secretary List</a></li>
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('admin.secretary.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
