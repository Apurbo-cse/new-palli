    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">secretary</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="">Dashboard</a></li>
                    <li><a href="{{route('admin.secretary.create')}}">secretary Create</a></li>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-end">
                    <h3 class="panel-title">
                        <button class="btn btn-primary  mx-5"><a href="{{route('admin.secretary.index')}}" class="text-white">All</a></button>
                ...
                <div class="panel-body">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        <tbody>
                        @foreach($s_members as $secretary)
                            <tr>
                                <td>{{$secretary->id}}</td>
                                <td>{{$secretary->name}}</td>
                                <td>{{$secretary->designation}}</td>
                                <td>{{$secretary->job}}</td>
                                <td>{{$secretary->job_location}}</td>
                                <td class="text-center"><img src="{{ asset($secretary->image) }}"  width="20%" alt=""></td>
                                <td>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('admin.secretary.destroy',$secretary->id) }}">
                                        @csrf
                                        @method('delete')
