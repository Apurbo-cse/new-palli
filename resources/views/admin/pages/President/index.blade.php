    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">President</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="">Dashboard</a></li>
                    <li><a href="{{route('admin.president.create')}}">President Create</a></li>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-end">
                    <h3 class="panel-title">
                        <button class="btn btn-primary  mx-5"><a href="{{route('admin.president.index')}}" class="text-white">All</a></button>
                        ...
                        @foreach($p_members as $president)
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('admin.president.destroy',$president->id) }}">
                                        @csrf
                                        @method('delete')
