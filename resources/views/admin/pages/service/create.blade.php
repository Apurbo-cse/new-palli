        ...
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li><a href="{{route('admin.service.index')}}">thana List</a></li>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('admin.service.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input value="{{old('title')}}" name="title" type="text" id="name" class="form-control" placeholder="name">
                                @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input name="info" class="form-control" rows="5" placeholder="Content">
                                @error('info')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
