            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-end">
                    <h3 class="panel-title">
                        <button class="btn btn-primary  mx-5"><a href="{{route('admin.service.index')}}" class="text-white">All</a></button>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        @foreach($services as $service)
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('admin.service.edit',$service->id) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
