        ...
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li><a href="{{route('admin.member.index')}}">thana List</a></li>
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('admin.member.store')}}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <label class="col-md-2 control-label">Member Type</label>
                            <div class="col-md-10">
                                <input value="{{old('member_type')}}" name="member_type" type="text" id="name" class="form-control" placeholder="name">
                                @error('member_type')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input name="designation" class="form-control" rows="5" placeholder="Content">{{ old('designation') }}</input>
                                @error('designation')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
