    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">member Committee</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="">Dashboard</a></li>
                    <li><a href="{{route('admin.member.create')}}">member Committee Create</a></li>
                    <li class="active">member Committee List</li>
                </ol>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-end">
                    <h3 class="panel-title">
                        <button class="btn btn-primary  mx-5"><a href="{{route('admin.member.index')}}" class="text-white">All</a></button>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        @foreach($members as $member)
                            <tr>
                                ...
                                <td>{{$member->job}}</td>
                                <td>{{$member->job_location}}</td>
                                <td class="text-center"><img src="{{ asset($member->image) }}"  width="20%" alt=""></td>
                                <td>
                                    @if ($member->status == 0)
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('admin.member.edit',$member->id) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('admin.member.destroy',$member->id) }}">
                                        @csrf
                                        @method('delete')
