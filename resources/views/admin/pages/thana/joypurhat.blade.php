            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-end d-flex">
                    <h3 class="panel-title">
                        <button class="btn btn-primary  mx-5"><a href="{{route('admin.int_thana.joypurhat')}}" class="text-white">Joypurhat Sadar</a></button>
                        ...
                        <button class="btn"> <a href="{{route('admin.int_thana.kalai')}}" class="active">Kalai</a></button>
