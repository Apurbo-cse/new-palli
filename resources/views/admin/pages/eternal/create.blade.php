        ...
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li><a href="{{route('admin.eternal.index')}}">thana List</a></li>
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('admin.eternal.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="eternal" id="summernote" class="form-control" cols="30" rows="10"></textarea>
                                @error('eternal')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
