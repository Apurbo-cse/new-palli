    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">eternal</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="">Dashboard</a></li>
                    <li><a href="{{route('admin.eternal.create')}}">eternal Create</a></li>
                    <li class="active">eternal List</li>
                </ol>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-end">
                    <h3 class="panel-title">
                        <button class="btn btn-primary  mx-5"><a href="{{route('admin.eternal.index')}}" class="text-white">All</a></button>
                ...
                <div class="panel-body">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <th class="text-center" >Eternal</th>
                        ...
                        @foreach($eternals as $eternal)
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('admin.eternal.edit',$eternal->id) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('admin.eternal.destroy',$eternal->id) }}">
                                        @csrf
                                        @method('delete')
