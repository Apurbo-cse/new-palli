...
@section('content')
  ...
  <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="active" href="{{route('admin.sub-category.create')}}">Category List</li>
                </ol>
    ...
    <div class="row m-b-15">
        <div class="col-sm-12">
            <a class="btn btn-primary" href="{{route('admin.sub-category.create')}}"><i class="fa fa-plus"></i> Create New Category</a>
        </div>
    </div> 
            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-end">
                    <h3 class="panel-title">
                        <button class="btn btn-primary  mx-5"><a href="{{route('admin.sub-category.index')}}" class="text-white">All</a></button>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        @foreach($sub_categories as $category)
                            ...
                            <td>{{$category->description}}</td>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('admin.sub-category.edit',$category->id) }}"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('admin.sub-category.destroy',$category->id) }}">
                                        @csrf
                                        @method('delete')
